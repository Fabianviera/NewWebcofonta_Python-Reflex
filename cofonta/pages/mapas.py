...
def mapa_shell(
    ...
    return rx.box(
        ...
        rx.box(
            ...
            padding=["8rem 1.5rem 2.5rem", "8rem 1.5rem 2.5rem", "9rem 3rem 3rem"],
        ...
        rx.flex(
            ...
            rx.vstack(
                ...
                rx.box(
                    ...
                    rx.hstack(
                        ...
                        align="flex-start", gap="0.9rem", margin_bottom="0.85rem",
                    ),
                    rx.hstack(
                        rx.text("📞", font_size="0.9rem", color=SKY, min_width="18px"),
            ...
            gap="3rem",
            align="flex-start",
            padding=["2rem 1.5rem", "2rem 1.5rem", "3rem 3rem"],
            max_width="1200px",
            margin="0 auto",
            width="100%",
        ),
